...
//
// Slice is a slice type whose Append method mutates in place and
// returns the updated slice, letting package-level var initializers
// across files append to a single value.
//
